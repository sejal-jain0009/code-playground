      ...
      <div className="mx-auto w-full max-w-6xl rounded-3xl border border-white/10 bg-slate-900/80 shadow-2xl">
        <div className="flex flex-wrap items-center justify-between rounded-t-3xl bg-slate-900/95 px-6 py-4">
          ...
          <div className="flex items-center gap-2">
            <select
              value="JavaScript"
              onChange={(e) => {
                const newLangRoute = e.target.value.toLowerCase();
                navigate(`/playground/${newLangRoute}`);
              }}
        ...
        <div className="grid gap-4 p-6 md:grid-cols-[1fr]">
          <div className="rounded-2xl border border-white/10 bg-slate-900/70 p-4">
            <h2 className="text-2xl font-bold text-cyan-300">JavaScript Code Playground</h2>
            <p className="mt-1 text-sm text-slate-300">
              Write JavaScript code, execute it in the browser, and inspect the result immediately.
            </p>
          </div>
